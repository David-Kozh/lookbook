...
<section className="relative flex flex-wrap h-[100%] items-center px-6 py-6 sm:px-8 lg:px-10 xl:px-28">
    ...
    <div className="flex flex-col justify-evenly bg-card dark rounded-lg h-[60%] lg:h-[65%] w-full mb-8 lg:mb-0 px-4 py-12 sm:px-6 sm:py-14 lg:w-1/2 lg:px-8 lg:py-20">
        ...
        <div className='flex justify-evenly my-6 gap-2'>
            <button className="flex gap-2 items-center rounded-lg bg-[#4540a5] px-4 py-4 font-medium text-white 
                hover:bg-[#9E9BDE] focus:outline-none focus:ring text-sm sm:text-base
            ...
            <button className="flex gap-2 items-center rounded-lg bg-[#4540a5] px-4 py-4 text-white 
                hover:bg-[#9E9BDE] focus:outline-none focus:ring font-medium text-sm sm:text-base
                hover:shadow-[2px_4px_0px_0px_rgba(0,0,0)] transition duration-200"
        ...
        <form onSubmit={handleLogin} className="mx-auto mb-0 mt-8 w-full space-y-4">
        {/* Email Input Box */}
        <div>
            ...
            <input type="email"
                id="email"
                className="w-full rounded-lg text-gray-400 p-4 pe-12 text-sm shadow-sm"
        ...
        <div className="flex items-center justify-between">
            <p className="flex flex-col sm:flex-row text-sm text-zinc-300 ml-2">
                No Google/Github account?
            <a className="underline sm:ml-2" href="/signup">Sign up with email</a>
            </p>

            <button type="submit"
                className="inline-block rounded-lg bg-[#4540a5] hover:bg-[#9E9BDE] px-5 py-3 text-sm font-medium text-white"
            >
                Sign in
            </button>
        </div>

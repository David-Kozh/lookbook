...
export function ContainerTextFlip({
  ...
  return (
    <motion.p
      ...
      className={cn(
        "relative inline-block rounded-lg pt-3.5 pb-3.5 text-center text-xs sm:text-sm md:text-base lg:text-lg font-bold font-mono text-gray-300 tracking-wider",

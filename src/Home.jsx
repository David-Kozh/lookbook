          ...
          <div className="grid grid-cols-1 h-content lg:grid-cols-2">
            ...
            <div className="relative flex items-center bg-[#203e63] shadow-xl shadow-black/30">
              ...
              <div className="p-8 sm:p-16 lg:p-24">
                ...
                <h2 className="bg-gradient-to-r from-[#D5AE7E] to-[#D47E7A] bg-clip-text text-2xl font-extrabold text-transparent sm:text-4xl 2xl:text-5xl tracking-wide">
                  LookBook
                </h2>
                ...
                <p className="mt-4 text-gray-200 font-medium 2xl:text-lg">
                ...
                <a
                  href="#"
                  className="mt-16 inline-block rounded-md bg-[#7b76d2ef] px-12 py-4 text-sm font-medium text-white 

        ...
        <div className="mx-auto max-w-screen-2xl px-4 py-4 md:py-16 sm:px-6 lg:px-8 h-full font-sans flex flex-col justify-center">
          <div className="grid grid-cols-1 h-content lg:grid-cols-2">
            ...
            <div className="relative flex items-center bg-secondary shadow-xl shadow-black/30">
              ...
              <div className="p-8 sm:p-12 xl:p-24">
                <h2 className="bg-gradient-to-r from-[#D5AE7E] to-[#D47E7A] dark:from-rose-500 dark:to-rose-700 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl 2xl:text-6xl tracking-wide">
                  LookBook 
                </h2>
                ...
                <div className="mt-6 text-gray-200 text-sm 2xl:text-lg font-mono">
